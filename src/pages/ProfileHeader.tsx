...
          <Avatar className="h-24 w-24 border"> {/* borderを追加 */}
            {/* user.icon_url を表示 */}
            <AvatarImage src={user.icon_url || "/placeholder.svg"} className="object-cover" />
            <AvatarFallback>
...
                  <div className="space-y-4 py-4">
                    ...
                    <div className="flex flex-col items-center gap-4">
                      ...
                      >
                          <AvatarImage src={previewUrl || "/placeholder.svg"} className="object-cover" />
