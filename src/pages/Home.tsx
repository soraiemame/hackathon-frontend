        ...
        <div className="flex flex-col">
                        ...
                        <CardContent className="pt-6">
                            <div className="flex flex-col items-center text-center gap-4">
                                ...
                                <p className="text-muted-foreground text-sm">
                                    写真を撮って、商品情報を入力するだけ。 誰でも簡単に出品できます。
                                </p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            <div className="flex flex-col items-center text-center gap-4">
                                ...
                                <p className="text-muted-foreground text-sm">
                                    エスクローシステムで、商品が届くまで 代金は運営が安全に保管します。
                                </p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            <div className="flex flex-col items-center text-center gap-4">
                                ...
                                <p className="text-muted-foreground text-sm">
                                    困ったときは24時間365日対応の カスタマーサポートがサポートします。
                                </p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            <div className="flex flex-col items-center text-center gap-4">
                                ...
                                <p className="text-muted-foreground text-sm">お互いの住所を知られることなく、 安心して取引できます。</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
            ...
            <section className="container px-4 py-16 md:py-24 md:px-6">
                <div className="flex flex-col items-center text-center gap-6 max-w-2xl mx-auto">
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-balance">今すぐ始めよう</h2>
                    <p className="text-lg text-muted-foreground">無料登録して、フリマを始めましょう</p>
                    <Button size="lg" asChild>
