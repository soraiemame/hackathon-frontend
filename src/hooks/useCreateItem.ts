...
async function getSignedUrl(file: File): Promise<{ uploadUrl: string, fileKey: string, file: File }> {
...
async function uploadToGCS(vars: { uploadUrl: string, file: File }): Promise<void> {
